...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "add_order": MessageLookupByLibrary.simpleMessage("إضافة طلب"),
        "agenda": MessageLookupByLibrary.simpleMessage("أجندة"),
        "agree_terms":
        ...
        "canvasBagSquareBottom":
            MessageLookupByLibrary.simpleMessage("حقيبة قماش بقاعدة مربعة"),
        "canvasBagWithHandle":
        ...
        "coffeeBagWithFilter":
            MessageLookupByLibrary.simpleMessage("كيس قهوة بفلتر"),
        "coffeeBagWithZipper":
        ...
        "large_format_sticker":
            MessageLookupByLibrary.simpleMessage("ستيكرات عريضة"),
        ...
        "molded_fiber_products":
            MessageLookupByLibrary.simpleMessage("منتجات الألياف"),
        ...
        "order_variation": MessageLookupByLibrary.simpleMessage(
            "بعض أنواع الطلبات التي تزيد أو تنقص بنسبة 10٪ عن الكمية المذكورة سيتم فاتورتها عند اكتمال الطلب وستتم إضافتها أو خصمها من المبلغ الإجمالي المتبقي."),
        "order_view": MessageLookupByLibrary.simpleMessage("عرض الطلب"),
        ...
        "paperCoffeeBag": MessageLookupByLibrary.simpleMessage("كيس قهوة ورقي"),
        "paperCup": MessageLookupByLibrary.simpleMessage("كوب ورقي"),
        "paperCupCorrugated":
        ...
        "plasticCoffeeBag":
            MessageLookupByLibrary.simpleMessage("كيس قهوة بلاستيك"),
        "plasticCup": MessageLookupByLibrary.simpleMessage("كوب بلاستيك"),
        "plasticCupPet":
        ...
        "quotation_condition_2": MessageLookupByLibrary.simpleMessage(
            "سيتواصل معك وكيل التطبيق لتحصيل الدفعة المقدمة."),
        "quotation_condition_3": MessageLookupByLibrary.simpleMessage(
            "سيتم إنشاء عينة من الطلب المكتمل وتوقيعها من قبل المشتري بعد دفع الدفعة المقدمة."),
        "quotation_condition_4": MessageLookupByLibrary.simpleMessage(
            "في نفس يوم التسليم، يجب دفع الرصيد المتبقي."),
        "quotation_condition_5": MessageLookupByLibrary.simpleMessage(
            "يتم تحديد تاريخ التسليم بناءً على الشكل والحجم والتفاصيل الخاصة بالطلب (قد يختلف الطلب عن آخر بناءً على التفاصيل)."),
        "quotation_condition_6": MessageLookupByLibrary.simpleMessage(
            "يجب إبلاغ مسؤول التطبيق بأي أخطاء في تفاصيل الطلب في نفس يوم التسليم باستخدام قنوات الاتصال المتوفرة في تطبيق المورد."),
        "quotation_condition_7": MessageLookupByLibrary.simpleMessage(
            "لا يمكن إرجاع الطلب إذا تجاوز التسليم يوم عمل واحد ويعتبر الطلب قد تم تسليمه بنجاح."),
        "quote_requests_comparison": MessageLookupByLibrary.simpleMessage(
            "طلبات عروض الأسعار والمقارنة"),
        "quotes_terms":
        ...
        "shoppingBagAsRequest":
            MessageLookupByLibrary.simpleMessage("كيس تسوق حسب الطلب"),
        ...
        "supplierterms": MessageLookupByLibrary.simpleMessage(
            "اﻟﺻﻼﺣﯾﺔ اﻟﻌرض : 10 أﯾﺎم ﻣن اﻟﺗﺎرﯾﺦ اﻟﻣذﻛور أﻋﻼه ﻣﻼﺣظﺔ: رﺑﻣﺎ ﺗﺗﺧﻠف ﺑﻌض اﻷﺳﻌﺎر ﻋﻧد اﻟطﻠب ﺑﻌد ﺗﺎرﯾﺦ ﺻﻼﺣﯾﺔ اﻟﻌرض. ﯾﺗم دﻓﻊ اﻟﻣﺑﻠﻎ %70 ﻣﻘدﻣًﺎ و%30 ﻗﺑل اﻻﺳﺗﻼم. ﺳﯾﺗم إﺻدار ﻓﺎﺗورة ﻟﺑﻌض أﻧواع اﻟطﻠﺑﺎت اﻟﺗﻲ ﺗزﯾد أو ﺗﻘل ﺑﻧﺳﺑﺔ %10 ﻋن اﻟﻛﻣﯾﺔ اﻟﻣذﻛورة ﻓﻲ وﻗت إﻛﻣﺎل اﻟطﻠب وﺳﯾﺗم إﺿﺎﻓﺗﮭﺎ أو ﺧﺻﻣﮭﺎ ﻣن اﻟﻣﺑﻠﻎ اﻹﺟﻣﺎﻟﻲ اﻟﻣﺗﺑﻘﻲ. ﺷروط وأﺣﻛﺎم اﻟدﻓﻊ ﺣﺎﻟﯾًﺎ، ھﻧﺎك طرﯾﻘﺗﺎن ﻟﻠدﻓﻊ: 1- ﻋن طرﯾق اﻟﺗﺣوﯾل اﻟﺑﻧﻛﻲ إﻟﻰ ﺣﺳﺎب اﻟﺷرﻛﺔ اﻟﻣﺎﻟﻛﺔ ﻟﻠﺗطﺑﯾق، واﻟذي ﯾﺗم ﻋرﺿﮫ أدﻧﺎه. 2- ﻋن طرﯾق اﻟﺗﺣﺻﯾل ﻣن أﺣد وﻛﻼء اﻟﺗطﺑﯾق. ﻛﻠﻣﺎ ﻗدﻣت طﻠﺑًﺎ، ﺳﻧﺗواﺻل ﻣﻌك ﻻﺳﺗﯾﻔﺎءه. ﺷروط وأﺣﻛﺎم ﻋروض اﻷﺳﻌﺎر 1- ﺑﻘﺑوﻟك ﻋرض اﻷﺳﻌﺎر ھذا، ﻓﺈﻧك ﺗواﻓق ﻋﻠﻰ ﺷروط وأﺣﻛﺎم ﻋروض اﻷﺳﻌﺎر وﺗﻘدم ﺗﻔﺎﺻﯾﻠك ﻟﺗﻘدﯾم اﻟطﻠب. 2- ﺳﯾﺗواﺻل ﻣﻌك وﻛﯾل اﻟﺗطﺑﯾق ﻟﺗﺄﻛﯾد اﻟطﻠب. 3- ﺳﯾﺗم إﻧﺷﺎء ﻋﯾﻧﺔ ﻣن اﻟطﻠب اﻟﻣراد إﻛﻣﺎﻟﮫ وﺗوﻗﯾﻌﮭﺎ ﻣن ﻗﺑﻠك ﺑﻌد دﻓﻊ اﻟودﯾﻌﺔ. 4- ﻗﺑل أو ﻓﻲ ﻧﻔس ﯾوم اﻟﺗﺳﻠﯾم، ﯾﺟب دﻓﻊ اﻟرﺻﯾد اﻟﻣﺗﺑﻘﻲ. 5- ﯾﺗم ﺗﺣدﯾد ﺗﺎرﯾﺦ اﻟﺗﺳﻠﯾم ﺣﺳب ﺷﻛل وﺣﺟم وﺗﻔﺎﺻﯾل اﻟطﻠب )ﻗد ﯾﺧﺗﻠف طﻠب ﻋن آﺧر ﺑﻧﺎءً ﻋﻠﻰ اﻟﺗﻔﺎﺻﯾل(. 6- ﺑﺎﺳﺗﺧﺪام ﻗﻧوات اﻻﺗﺻﺎل اﻟﺗﻲ ﯾوﻓرھﺎ ﺗطﺑﯾق اﻟﻣورد، ﯾﺟب إﺑﻼغ ﻣﺳؤول اﻟﺗطﺑﯾق ﺑﺄي أﺧطﺎء ﻓﻲ ﺗﻔﺎﺻﯾل اﻟطﻠب ﻓﻲ ﻧﻔس ﯾوم اﻟﺗﺳﻠﯾم. 7- ﻻ ﯾﻣﻛن إرﺟﺎع اﻟطﻠب إذا ﺗﺟﺎوز اﻟﺗﺳﻠﯾم ﯾوم ﻋﻣل واﺣد وﯾﻌﺗﺑر اﻟطﻠب ﻗد ﺗم ﺗﺳﻠﯾﻣﮫ ﺑﻧﺟﺎح. 8- اﻟﺣد اﻷدﻧﻰ ﻟﻠطﻠب ھو ٥۰۰ درھم إﻣﺎراﺗﻲ، وآي طﻠب آﻗل ﻣن ذﻟك ﺳﯾﺗم ﺣذﻓﮫ ﻣﺑﺎﺷرة. ﻷي أﺳﺋﻠﺔ أﺧرى ﺑﺧﺻوص ﻋرض اﻟﺳﻌر، ﻻ ﺗﺗردد ﻓﻲ اﻻﺗﺻﺎل ﺑﻧﺎ ﻣن ﺧﻼل اﻟرﺳﺎﺋﻞ اﻟﻔورﯾﺔ داﺧل اﻟﺗطﺑﯾق أو ﻋﻠﻰ support@supplieruae.com."),
        ...
        "terms_client": MessageLookupByLibrary.simpleMessage(
            "يوفر هذا التطبيق خدمة الحصول على عروض الأسعار والتسويق للشركات مجانًا.\nلا يتم جمع أي رسوم من المشتري،\nتوصيل مجاني، تسجيل مجاني.\nمرحبًا بكم في تطبيق SUPPLIER! باستخدامك للوصول إلى التطبيق أو استخدامه، فإنك توافق على الامتثال لهذه الشروط والأحكام وتكون ملزمًا بها. يرجى قراءتها بعناية.\nإذا كنت لا توافق على أي جزء من هذه الشروط، فلا يحق لك استخدام خدمتنا.\n1. التعريفات\n* التطبيق: يشير إلى تطبيق SUPPLIER على الهاتف المحمول.\n* المستخدم: أي فرد أو كيان يصل إلى التطبيق، بما في ذلك كل من المشترين والبائعين.\n* المشتري: المستخدم الذي يبحث عن خدمات الطباعة والتغليف والإعلانات.\n* البائع: المستخدم الذي يقدم خدمات الطباعة والتغليف والإعلانات.\n* الخدمات: تشير إلى جميع الوظائف التي يقدمها SUPPLIER، بما في ذلك طلبات العروض، ومقارنات الأسعار، وأدوات الاتصال.\n2. قبول الشروط\nمن خلال إنشاء حساب أو الوصول إلى التطبيق أو استخدامه، فإنك تقبل وتوافق على هذه الشروط وسياسة الخصوصية الخاصة بنا. يحتفظ SUPPLIER بالحق في تعديل هذه الشروط في أي وقت. يُنصح المستخدمون بمراجعة هذه الشروط بشكل دوري.\n3. حسابات المستخدم\n3.1 تسجيل الحساب: للوصول إلى ميزات معينة، يجب على المستخدمين إنشاء حساب من خلال تقديم معلومات دقيقة وكاملة. يتحمل المستخدمون مسؤولية الحفاظ على سرية معلومات تسجيل الدخول الخاصة بهم.\n3.2 تعليق/إنهاء الحساب: يحتفظ SUPPLIER بالحق في تعليق أو إنهاء الحسابات التي تنتهك هذه الشروط أو تشارك في أنشطة احتيالية أو مسيئة.\n4. الخدمات المقدمة\n4.1 استخدام المنصة: يقوم SUPPLIER بربط المشترين والبائعين في صناعة الطباعة والتغليف والإعلانات، ونحن نشارك في الإشراف على المعاملات. SUPPLIER غير مسؤول عن جودة أو دقة أو توقيت الخدمات المقدمة من قبل البائعين.\n4.2 طلبات العروض والاتصال: يمكن للمشترين طلب عروض من البائعين. جميع التفاعلات، بما في ذلك المفاوضات والمدفوعات وتنفيذ الخدمة، تتم من خلال تطبيق SUPPLIER فقط.\n5. التزامات المستخدم والسلوك\n5.1 الأنشطة المحظورة: يوافق المستخدمون على عدم الانخراط في أنشطة احتيالية أو تشهيرية أو ضارة، كما يتعهدون بعدم إساءة استخدام خدمات التطبيق بأي طريقة.\n5.2 الامتثال للقوانين: يجب على المستخدمين الامتثال لجميع القوانين والأنظمة المعمول بها أثناء استخدام التطبيق.\n5.3 الالتزامات القانونية للعملاء:\nتقر وتلتزم، بصفتك طرفًا في هذا الاتفاق، بـ:\nالامتثال للقوانين المعمول بها في جميع الأوقات وللتشريعات والأنظمة، بما في ذلك – دون استثناء – جميع تشريعات وقوانين وأنظمة حماية الخصوصية.\nكما تقر بأن لديك كل الصلاحيات والقدرات للدخول في هذا الاتفاق ودفع المستحقات وفقًا للشروط والأحكام الواردة فيه.\nإذا قمت بشراء المنتج نيابة عن شركة، فإنك تؤكد بأنك تمثلها وتتصرف نيابة عنها وأنك ستلتزم بهذه شروط الشراء.\n5.4 التواصل بين البائعين والمشترين:\nيُحظر التواصل بين البائع والمشتري من أجل الحفاظ على جودة الخدمة والالتزام بمعايير التطبيق.\nيحق للمستخدم التواصل مع تطبيق SUPPLIER في أي وقت ومن خلال وسائل الاتصال المتاحة داخل التطبيق.\n5.5 في حال حدوث تواصل غير قانوني بين البائع والمشتري، سواء كان ذلك بإضافة رقم هاتف أو عنوان أو أي وسيلة اتصال داخل التطبيق،\nفإن لتطبيق SUPPLIER الحق في حظر البائع والمشتري دون الرجوع إليهما ودون تحمل أي مسؤولية تجاههما.\n6. المدفوعات والرسوم\n6.1 التسعير: تُحدد الأسعار للخدمات من قبل البائعين.\n6.2 معالجة المعاملات: قد يقوم SUPPLIER بتسهيل معاملات الدفع من خلال مقدمي خدمات تطبيق SUPPLIER الآمنين. ونحن نتولى المسؤولية عن إتمام أو جودة الخدمات بمجرد إجراء الدفع.\n6.3 طريقة الدفع: لا توجد طريقة للدفع عبر الإنترنت في الوقت الحالي، وعند إضافة طريقة دفع، سيقوم تطبيق SUPPLIER بإبلاغ العملاء مباشرة.\n7. الملكية الفكرية\nSUPPLIER وجميع الشعارات والتصاميم والعلامات التجارية المرتبطة به هي ملك لـ SUPPLYER PORTAL. يُمنع الاستخدام أو التوزيع غير المصرح به لهذه المواد بشكل صارم.\n8. سياسة الخصوصية\nتشكل سياسة الخصوصية الخاصة بنا، التي توضح كيف نقوم بجمع واستخدام وحماية المعلومات الشخصية، جزءًا من هذه الشروط. باستخدام التطبيق، فإنك توافق على الشروط الواردة في سياسة الخصوصية الخاصة بنا.\n9. تسوية المنازعات\n9.1 منازعات المستخدم: يتم حل أي نزاع ينشأ بين المستخدم وتطبيق SUPPLIER من خلال SUPPLYER PORTAL.\n9.2 القانون الحاكم: تخضع هذه الشروط لقوانين [الإمارات العربية المتحدة].\nأي نزاعات تنشأ عن هذه الشروط أو عن استخدام تطبيق SUPPLIER ستكون خاضعة للاختصاص القضائي الحصري للمحاكم في [دبي].\n10. إخلاء المسؤولية\nيوفر تطبيق SUPPLIER خدماته على الحالة التي هي عليها دون أي ضمانات. نحن لا نضمن الوصول المستمر أو الدقة أو الموثوقية أو ملاءمة أي من الخدمات المقدمة عبر التطبيق.\n11. التغييرات في الشروط\nيحتفظ تطبيق SUPPLIER بالحق في تعديل هذه الشروط في أي وقت. سيتم إخطار المستخدمين بالتغييرات الجوهرية، ويُعتبر الاستمرار في استخدام التطبيق قبولاً للشروط المعدلة.\n12. اتصل بنا\nإذا كانت لديك أسئلة بخصوص هذه الشروط، يرجى الاتصال بنا على [info@supplieruae.com].\n13. الإقرار\nباستخدامك لتطبيق SUPPLIER، فإنك تقر بأنك قد قرأت وفهمت ووافقت على هذه الشروط والأحكام. إذا كنت لا توافق على هذه الشروط،\nيرجى التوقف عن استخدام التطبيق."),
        ...
        "update_info": MessageLookupByLibrary.simpleMessage("تحديث الييانات"),
        "usb": MessageLookupByLibrary.simpleMessage("فلاش ميموري"),
        ...
        "your_order": MessageLookupByLibrary.simpleMessage("طلباتك")
      };
}
